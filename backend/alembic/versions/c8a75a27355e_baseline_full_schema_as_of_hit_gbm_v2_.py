...
def upgrade() -> None:
    ...
    op.create_table('pitcher_k_runs',
    sa.Column('run_id', sa.String(length=36), nullable=False),
    ...
    op.create_index('ix_pitcher_k_runs_date_approach_public', 'pitcher_k_runs', ['projection_date', 'approach', 'is_public'], unique=False)
    op.create_index('ix_pitcher_k_runs_comparison_group', 'pitcher_k_runs', ['comparison_group_id'], unique=False)
    op.create_table('pitcher_k_predictions',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('run_id', sa.String(length=36), nullable=False),
    sa.Column('projection_date', sa.String(length=10), nullable=False),
    sa.Column('approach', sa.String(length=30), nullable=False),
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('run_id', 'game_pk', 'pitcher_id', name='uq_pitcher_k_prediction_run_game_pitcher')
    )
    op.create_index('ix_pitcher_k_predictions_date_approach', 'pitcher_k_predictions', ['projection_date', 'approach'], unique=False)
    op.create_index('ix_pitcher_k_predictions_game_pitcher', 'pitcher_k_predictions', ['game_pk', 'pitcher_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index('ix_pitcher_k_predictions_game_pitcher', table_name='pitcher_k_predictions')
    op.drop_index('ix_pitcher_k_predictions_date_approach', table_name='pitcher_k_predictions')
    op.drop_table('pitcher_k_predictions')
    op.drop_index('ix_pitcher_k_runs_comparison_group', table_name='pitcher_k_runs')
    op.drop_index('ix_pitcher_k_runs_date_approach_public', table_name='pitcher_k_runs')
