 ...
 * stats and rolling time-window stats.
 *
 ...
 *
 * Props:
 * - activePeriod: The currently selected period ('season' or a numeric day window)
...
function TimePeriodSelector({ activePeriod, onPeriodChange, loading, periods = DEFAULT_PERIODS }) {
  /**
   ...
   *          Numeric values represent days to look back.
